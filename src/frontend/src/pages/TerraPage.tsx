    ...
    <div style={{ background: "var(--neural-bg)", minHeight: "100vh" }}>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <div
            className="p-12 rounded-sm text-center terra-reveal reveal relative overflow-hidden"
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(34,211,176,0.07) 0%, rgba(4,5,14,0.95) 60%)",
          ...
          >
            <div
              ...
              style={{
                height: "1px",
                background:
                  "linear-gradient(90deg, transparent, rgba(34,211,176,0.4), transparent)",
              }}
              aria-hidden="true"
            />
            ...
            >
              ...
              Research teams are being assembled, field stations are being
              scoped, and the first climate equity framework is in development.
              Join the research network when we open.
            </p>
          </div>
        </div>
      </section>
