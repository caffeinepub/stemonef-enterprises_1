  ...
  return (
    <>
      ...
      <button
        ...
        style={{
          background: isOpen ? "rgba(212,160,23,0.15)" : "rgba(4,5,14,0.9)",
          border: `1px solid ${isOpen ? "rgba(212,160,23,0.6)" : "rgba(74,126,247,0.4)"}`,
          boxShadow: isOpen
            ? "0 0 25px rgba(212,160,23,0.3)"
            : "0 0 20px rgba(74,126,247,0.2)",
      ...
      >
        <span
          ...
          style={{ color: isOpen ? "#d4a017" : "rgba(74,126,247,0.9)" }}
        >
          ×
        </span>
      </button>
